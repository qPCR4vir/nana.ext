...
namespace nana
{
    ...
    public:
        ...
        group(widget &owner, ::nana::string titel={}, rectangle r={})
            : panel  (owner, r), 
              titel  (*this, titel),
              fmt    ("vertical margin=[0,3,3,3] <weight=18 <weight=5> <titel weight=80> >")
        {
            plc["titel"] << titel;
            drawing dw(*this);
		    dw.draw([](paint::graphics& graph)
...
//    place plc(fm);
//
//    group grp1(fm, STR("Group1:"), rectangle{ 220, 10, 200, 200 });
